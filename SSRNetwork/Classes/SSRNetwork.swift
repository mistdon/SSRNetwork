...
public typealias SSSNetworkSuccess = (_ response: SSRResponse, _ dataResponse: DataResponse<Any>?) -> Void

public typealias SSRNetworkFailure = (_ error: NSError?) -> Void
/// Default timeout Interval (默认超时时间)
public var SSRNetworkDefaultTimeOut : TimeInterval = 60

public class SSRNetwork{
    
    public static let shared = SSRNetwork()
    ...
    public var customHeaders: [String: String] = ["Accept": "application/json"]
